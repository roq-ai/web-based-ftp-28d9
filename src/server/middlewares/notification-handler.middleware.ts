...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'ftp_user.create': {
    roles: ['administrator', 'team-member'],
    key: 'ftp-user-created',
    tenantPath: ['organization', 'ftp_server', 'ftp_user'],
    userPath: [],
  },
  'ftp_user.update': {
    roles: ['administrator', 'team-member'],
    key: 'ftp-user-updated',
    tenantPath: ['organization', 'ftp_server', 'ftp_user'],
    userPath: [],
  },
  'ftp_user.delete': {
    roles: ['administrator', 'team-member'],
    key: 'ftp-user-deleted',
    tenantPath: ['organization', 'ftp_server', 'ftp_user'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['administrator', 'team-member'];
