...
import { getFtpServerById } from 'apiSdk/ftp-servers';
import { FtpServerInterface } from 'interfaces/ftp-server';
import { FtpUserListPage } from 'pages/ftp-users';

function FtpServerViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('ftp_server', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/ftp-servers/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Ip Address" text={data?.ip_address} />

                <FormListItem label="Port" text={data?.port} />
