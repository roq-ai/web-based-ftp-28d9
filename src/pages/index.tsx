...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`Web based FTP`}</title>

        <meta
          name="description"
          content="Welcome to Web based FTP - Your one-stop solution for efficient FTP management. Create, manage and allocate rights to FTP users and folders, all from the convenience of your web browser."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1658314756249-8cecdff26d29?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxmdHAlMjBzZXJ2ZXJ8ZW58MHx8fHwxNjkyNjEzNzUyfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Web based FTP - Your one-stop solution for efficient FTP management. Create, manage and allocate rights to FTP users and folders, all from the convenience of your web browser.`}
            </Text>
            <Box
